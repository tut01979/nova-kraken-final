...
exchange = ccxt.krakenfutures({
    'apiKey': os.getenv("KRAKEN_API_KEY"),  # ← Clave pública (la larga)
    'secret': os.getenv("KRAKEN_SECRET"),   # ← Clave privada (la corta)
    'password': os.getenv("KRAKEN_SECRET"),  # ← Tu idea: clave privada repetida
